...
public class AnnotationProcessor {
    ...
    public void process(RealList<TypeData<?>, RealType<?, ?, ?>> types, RealObject<?, ?, ?, ?> object) {
        if(object instanceof com.intuso.housemate.object.v1_0.api.Command.Container)
            parseCommands(types, object, ((com.intuso.housemate.object.v1_0.api.Command.Container<RealList<CommandData, RealCommand>>)object).getCommands());
        if(object instanceof com.intuso.housemate.object.v1_0.api.Property.Container)
            parseProperties(types, object, ((com.intuso.housemate.object.v1_0.api.Property.Container<RealList<PropertyData, RealProperty<?>>>) object).getProperties());
        if(object instanceof com.intuso.housemate.object.v1_0.api.Value.Container)
            parseValues(types, object, ((com.intuso.housemate.object.v1_0.api.Value.Container<RealList<ValueData, RealValue<?>>>) object).getValues());
