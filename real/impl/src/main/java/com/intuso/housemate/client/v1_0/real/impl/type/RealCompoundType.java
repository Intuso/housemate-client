...
public abstract class RealCompoundType<O>
    ...
    protected RealCompoundType(Logger logger, ListenersFactory listenersFactory, String id, String name, String description, int minValues,
        ...
        this.subTypes = new RealListImpl<>(ChildUtil.logger(logger, SUB_TYPES_ID), new com.intuso.housemate.client.v1_0.api.object.List.Data(SUB_TYPES_ID, SUB_TYPES_NAME, SUB_TYPES_DESCRIPTION), listenersFactory, subTypes);
    }
