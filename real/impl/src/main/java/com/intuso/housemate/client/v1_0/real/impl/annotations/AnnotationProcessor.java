...
import com.intuso.housemate.client.v1_0.real.api.annotations.Parameter;
import com.intuso.housemate.client.v1_0.real.api.device.feature.RealFeature;
...
public class AnnotationProcessor {
    ...
    public void process(RealObject<?, ?, ?, ?> object, Object driver) {
        if(object instanceof com.intuso.housemate.object.v1_0.api.Command.Container)
            parseCommands(object, driver, ((com.intuso.housemate.object.v1_0.api.Command.Container<RealListImpl<CommandData, RealCommandImpl>>)object).getCommands());
        if(object instanceof com.intuso.housemate.object.v1_0.api.Property.Container)
            parseProperties(object, driver, ((com.intuso.housemate.object.v1_0.api.Property.Container<RealListImpl<PropertyData, RealPropertyImpl<?>>>) object).getProperties());
        if(object instanceof com.intuso.housemate.object.v1_0.api.Value.Container)
            parseValues(object, driver, ((com.intuso.housemate.object.v1_0.api.Value.Container<RealListImpl<ValueData, RealValueImpl<?>>>) object).getValues());
