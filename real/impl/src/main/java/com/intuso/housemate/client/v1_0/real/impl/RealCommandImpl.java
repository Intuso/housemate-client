...
public final class RealCommandImpl
    ...
    protected final void initChildren(String name) {
        ...
        performStatusSender = senderFactory.create(logger, com.intuso.housemate.client.v1_0.messaging.api.Type.Topic, ChildUtil.name(name, Command.PERFORM_STATUS_ID));
        performReceiver = receiverFactory.create(logger, com.intuso.housemate.client.v1_0.messaging.api.Type.Queue, ChildUtil.name(name, Command.PERFORM_ID), PerformData.class);
