...
public class TypesV1_0PluginsListener implements PluginListener {
    ...
    @Inject
    public TypesV1_0PluginsListener(@Type Logger typeLogger, Injector injector, TypeRepository types, RealRegexType.Factory regexTypeFactory, ConditionDriverType conditionDriverType, HardwareDriverType hardwareDriverType, TaskDriverType taskDriverType) {
    ...
    private void addHardwareDriverFactories(Plugin plugin) {
        for(HardwareDriver hardwareDriver : plugin.getHardwareDrivers()) {
            ...
            if(id == null)
                ...
                hardwareDriverType.addFactory(id.value(), id.name(), id.description(), asFactory(com.intuso.housemate.client.v1_0.api.driver.HardwareDriver.class, com.intuso.housemate.client.v1_0.api.driver.HardwareDriver.Factory.class, hardwareDriver.value()));
        }
    }
