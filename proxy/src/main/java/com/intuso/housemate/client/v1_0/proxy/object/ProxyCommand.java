...
public abstract class ProxyCommand<
    ...
    protected void initChildren(String name) {
        ...
        performSender = senderFactory.create(logger, com.intuso.housemate.client.v1_0.messaging.api.Type.Queue, ChildUtil.name(name, PERFORM_ID));
        performStatusReceiver = receiverFactory.create(logger, com.intuso.housemate.client.v1_0.messaging.api.Type.Topic, ChildUtil.name(name, PERFORM_STATUS_ID), PerformStatusData.class);
