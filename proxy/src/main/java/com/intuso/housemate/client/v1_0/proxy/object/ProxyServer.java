 ...
 * @param <DEVICE_GROUPS> the type of the devices list
...
public abstract class ProxyServer<
    ...
    public ProxyServer(Logger logger,
        ...
        super(logger, null, ChildUtil.name(null, PROXY, VERSION, "javabin" /* todo make this configurable? */), Server.Data.class, managedCollectionFactory, receiverFactory);
