...
public abstract class ProxyValueBase<
    ...
    protected void initChildren(String name) {
        ...
        valueReceiver = receiverFactory.create(logger, com.intuso.housemate.client.v1_0.messaging.api.Type.Topic, ChildUtil.name(name, VALUE_ID), Type.Instances.class);
