...
import com.intuso.housemate.client.v1_0.api.object.view.AutomationView;
...
public interface Automation<RENAME_COMMAND extends Command<?, ?, ?, ?>,
    ...
    String SATISFIED_TASKS_ID = "satisfied-tasks";
    String UNSATISFIED_TASKS_ID = "unsatisfied-tasks";
