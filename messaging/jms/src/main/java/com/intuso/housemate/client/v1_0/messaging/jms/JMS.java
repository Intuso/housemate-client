...
public class JMS {
    ...
    public static class Sender implements com.intuso.housemate.client.v1_0.messaging.api.Sender {
        ...
        public static class FactoryImpl implements com.intuso.housemate.client.v1_0.messaging.api.Sender.Factory {
            ...
            @Override
            public com.intuso.housemate.client.v1_0.messaging.api.Sender create(Logger logger, String name) {
                try {
     ...
     */
    public static class Receiver<T extends Serializable> implements com.intuso.housemate.client.v1_0.messaging.api.Receiver<T> {
        ...
        public static class FactoryImpl implements com.intuso.housemate.client.v1_0.messaging.api.Receiver.Factory {
            ...
            @Override
            public <T extends Serializable> com.intuso.housemate.client.v1_0.messaging.api.Receiver create(Logger logger, String name, Class<T> tClass) {
                try {
